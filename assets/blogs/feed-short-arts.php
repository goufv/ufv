...
$postimages = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'large' );
// Check for images
if ( $postimages ) { 	$postimage = $postimages[0]; } else { $postimage = 'https://www.ufv.ca/media/2015/blogs/ufv-news-events-blogs.jpg'; }
...
?>			
			<item>
				...
				<guid isPermaLink="false"><?php the_guid(); ?></guid><?php /* <author><?php the_author(); ?></author>  */ ?>
				...
				<pubDate2><?php echo get_post_time( 'Y-m-d H:i:s', true ); ?></pubDate2>
				<updated><?php 
    echo mysql2date(
        'Y-m-d\TH:i:s\Z', 
...
?></lastBuildDate>
				<description>
<?php /*					<![CDATA[<?php echo the_excerpt_rss(); echo $postlink; echo my_rss_related(); ?>]]> */ ?>
				<![CDATA[<?php 
						$excerpt = get_the_excerpt();
						$excerpt = substr($excerpt,0,300);
						echo $excerpt . ' ...';
						//echo the_excerpt_rss($numwords); 
						?>]]>
				</description>
			</item><?php endwhile; ?>
	</channel>
